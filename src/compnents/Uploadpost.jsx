      ...
      <div className=' row  ' >
        ...
        <div className='col-sm-7 pt-2'>
          <form onSubmit={submitHandler} >
            <input type='text' onChange={changeHandler1} name='content' value={content} placeholder='start a post.....' className='rounded-pill   border border-1  h-75 w-100 rounded-3 bg-light  ' />
            <input type='file' onChange={changeHandler2} className=' form-control-files ' accept='image/*' multiple />
            <input type='submit' />
          </form>
